---
title: "Team HW#1"
author: "Noam Benkler, Daniel Matsuda"
...
```{r, echo=FALSE}
#Plot
efficientcars <- vehicles %>% filter(hwy >= 45)

efficientcars %>% 
  filter(fuel %in% c("Regular", "Diesel", "Electricity")) %>% 
  ggplot(aes(y=hwy, 
             x=year, 
             color = fuel)) + 
  ...
  labs(x= "Year",
       ...
       title = "Highway Fuel Economy of Fuel Efficient Vehicles From 1984 to 2015",
       subtitle = "*Fuel Efficient Vehicles Classified as Vehicles with Highway Fuel Economy of Greater than 45 MPG",
       color ="Fuel Type") +
